...
<body>
    ...
    @endif
    <form action="{{route('procesarActualizacion')}}" method="post" accept="UTF-8" >
        @csrf
            <div class="container">
                <h1>Actualizacion de información</h1>
                <div class="shadow-lg contact__wrapper mt-n9">
                    <div class="row no-gutters">
                        ...
                        <div class="p-5 col-lg-7 contact-form__wrapper order-lg-1">
                            <form action="#" class="contact-form form-validate" novalidate="novalidate">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-sm-12">
                                        <div class="form-group">
                                            <label class="required-field " for="motivo">Puesto de Votacion</label>
                                            <select class="form-select select2-example " name="puesto" id="puesto">
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="mesa" name="mesa" placeholder="Mesa" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-sm-12">
                                        <button type="submit" class="btn btn-felipe ">Actualizar puesto de votacion</button>
                                    </div>
                        ...
                        <div class="p-5 col-lg-5 contact-info__wrapper gradient-brand-color order-lg-2">
                            <h3 class="mb-5 color--white">Actualizacion datos</h3>
