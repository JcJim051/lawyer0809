...
@section('content_header')
    <h1 style="text-align: center">Tablero de Cambios</h1>
@stop
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->gob1 }}</td>
                            ...
                            @endif  
                            {{-- municipal    --}}
                            @if ( $data->votos->gob1_municipal == $data->votos->gob1_zonal)
                                <td>{{ $data->votos->gob1_municipal }}</td>   
                            @else
                                <td style="color:red">{{ $data->votos->gob1_municipal }}</td>
                            @endif
                            {{-- Departamental --}}
                            @if ( $data->votos->gob1_departamental == $data->votos->gob1_nunicipal)
