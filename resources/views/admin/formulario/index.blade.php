                ...
                <div class="shadow-lg contact__wrapper mt-n9">
                    <div class="row no-gutters">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime" class="form-control" id="fecha" name="fecha" value="{{$fechaHoraActual->format('Y-m-d H:i:s')}} " readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class=" form-select js-example-basic-single" name="codigo_abogado" id="codigo_abogado" required>
                        ...
                        <div class="p-5 col-lg-5 contact-info__wrapper gradient-brand-color order-lg-2">
                            ...
                            <figure class="m-0 figure position-absolute opacity-06 z-index-100" style="bottom:0; right: 10px">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="444px" height="626px">
                                    ...
                                    <path fill-rule="evenodd" opacity="0.302" fill="rgb(72, 155, 10)" d="M816.210,-41.714 L968.999,111.158 L-197.210,1277.998 L-349.998,1125.127 L816.210,-41.714 Z"></path>
